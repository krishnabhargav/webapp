...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13236 = {};return obj13236;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9595__auto__ = this$;if(and__9595__auto__)
...
{var x__10243__auto__ = (((this$ == null))?null:this$);return (function (){var or__9607__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10243__auto__)]);if(or__9607__auto__)
{return or__9607__auto__;
} else
{var or__9607__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9607__auto____$1)
...
return (function (p__13237){var vec__13238 = p__13237;var k = cljs.core.nth.call(null,vec__13238,(0),null);var v = cljs.core.nth.call(null,vec__13238,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13239){var vec__13240 = p__13239;var k = cljs.core.nth.call(null,vec__13240,(0),null);var v = cljs.core.nth.call(null,vec__13240,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
