...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10525 = {};return obj10525;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7708__auto__ = this$;if(and__7708__auto__)
...
{var x__8356__auto__ = (((this$ == null))?null:this$);return (function (){var or__7720__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8356__auto__)]);if(or__7720__auto__)
{return or__7720__auto__;
} else
{var or__7720__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7720__auto____$1)
...
return (function (p__10526){var vec__10527 = p__10526;var k = cljs.core.nth.call(null,vec__10527,(0),null);var v = cljs.core.nth.call(null,vec__10527,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10528){var vec__10529 = p__10528;var k = cljs.core.nth.call(null,vec__10529,(0),null);var v = cljs.core.nth.call(null,vec__10529,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
