...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16715 = (0);while(true){
var m_16716 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16716 == null))
{} else
{m_16716.call(null);
if((count_16715 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16717 = (count_16715 + (1));
count_16715 = G__16717;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8546__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8546__auto__)
