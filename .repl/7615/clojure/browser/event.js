...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj15673 = {};return obj15673;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7715__auto__ = this$;if(and__7715__auto__)
...
{var x__8363__auto__ = (((this$ == null))?null:this$);return (function (){var or__7727__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8363__auto__)]);if(or__7727__auto__)
{return or__7727__auto__;
} else
{var or__7727__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7727__auto____$1)
...
return (function (p__15674){var vec__15675 = p__15674;var k = cljs.core.nth.call(null,vec__15675,(0),null);var v = cljs.core.nth.call(null,vec__15675,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__15676){var vec__15677 = p__15676;var k = cljs.core.nth.call(null,vec__15677,(0),null);var v = cljs.core.nth.call(null,vec__15677,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
