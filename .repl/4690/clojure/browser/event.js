...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10589 = {};return obj10589;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7772__auto__ = this$;if(and__7772__auto__)
...
{var x__8420__auto__ = (((this$ == null))?null:this$);return (function (){var or__7784__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8420__auto__)]);if(or__7784__auto__)
{return or__7784__auto__;
} else
{var or__7784__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7784__auto____$1)
...
return (function (p__10590){var vec__10591 = p__10590;var k = cljs.core.nth.call(null,vec__10591,(0),null);var v = cljs.core.nth.call(null,vec__10591,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10592){var vec__10593 = p__10592;var k = cljs.core.nth.call(null,vec__10593,(0),null);var v = cljs.core.nth.call(null,vec__10593,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
