...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10516 = {};return obj10516;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7699__auto__ = this$;if(and__7699__auto__)
...
{var x__8347__auto__ = (((this$ == null))?null:this$);return (function (){var or__7711__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8347__auto__)]);if(or__7711__auto__)
{return or__7711__auto__;
} else
{var or__7711__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7711__auto____$1)
...
return (function (p__10517){var vec__10518 = p__10517;var k = cljs.core.nth.call(null,vec__10518,(0),null);var v = cljs.core.nth.call(null,vec__10518,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10519){var vec__10520 = p__10519;var k = cljs.core.nth.call(null,vec__10520,(0),null);var v = cljs.core.nth.call(null,vec__10520,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
