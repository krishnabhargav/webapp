...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj12847 = {};return obj12847;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9203__auto__ = this$;if(and__9203__auto__)
...
{var x__9851__auto__ = (((this$ == null))?null:this$);return (function (){var or__9215__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__9851__auto__)]);if(or__9215__auto__)
{return or__9215__auto__;
} else
{var or__9215__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9215__auto____$1)
...
return (function (p__12848){var vec__12849 = p__12848;var k = cljs.core.nth.call(null,vec__12849,(0),null);var v = cljs.core.nth.call(null,vec__12849,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__12850){var vec__12851 = p__12850;var k = cljs.core.nth.call(null,vec__12851,(0),null);var v = cljs.core.nth.call(null,vec__12851,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
