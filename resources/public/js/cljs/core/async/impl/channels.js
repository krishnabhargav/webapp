...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16721 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16721 = (function (val,box,meta16722){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16721.cljs$lang$type = true;
cljs.core.async.impl.channels.t16721.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16721";
cljs.core.async.impl.channels.t16721.cljs$lang$ctorPrWriter = (function (this__9134__auto__,writer__9135__auto__,opt__9136__auto__){return cljs.core._write.call(null,writer__9135__auto__,"cljs.core.async.impl.channels/t16721");
});
cljs.core.async.impl.channels.t16721.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16721.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16723){var self__ = this;
var _16723__$1 = this;return self__.meta16722;
});
cljs.core.async.impl.channels.t16721.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16723,meta16722__$1){var self__ = this;
var _16723__$1 = this;return (new cljs.core.async.impl.channels.t16721(self__.val,self__.box,meta16722__$1));
});
cljs.core.async.impl.channels.__GT_t16721 = (function __GT_t16721(val__$1,box__$1,meta16722){return (new cljs.core.async.impl.channels.t16721(val__$1,box__$1,meta16722));
});
}
return (new cljs.core.async.impl.channels.t16721(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9137__auto__,writer__9138__auto__,opts__9139__auto__){return cljs.core._write.call(null,writer__9138__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9134__auto__,writer__9135__auto__,opt__9136__auto__){return cljs.core._write.call(null,writer__9135__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16724 = self__.takes.pop();if((taker_16724 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16724))
{var take_cb_16725 = cljs.core.async.impl.protocols.commit.call(null,taker_16724);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16725,taker_16724,this$__$1){
return (function (){return take_cb_16725.call(null,null);
});})(take_cb_16725,taker_16724,this$__$1))
);
} else
{}
{
