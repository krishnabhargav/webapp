...
{{
var G__13975 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13975;
continue;
}
} else
...
{var pred__13979 = cljs.core._EQ_;var expr__13980 = limit;if(cljs.core.truth_(pred__13979.call(null,(1),expr__13980)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13979.call(null,(2),expr__13980)))
...
var G__13982 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13983 = (limit__$1 - (1));
var G__13984 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13982;
limit__$1 = G__13983;
parts = G__13984;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13986 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13986))
{var replacement_13987 = temp__4124__auto___13986;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13987)));
} else
{buffer.append(ch);
}
{
var G__13988 = (index + (1));
index = G__13988;
continue;
}
}
