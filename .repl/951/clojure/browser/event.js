...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13243 = {};return obj13243;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9563__auto__ = this$;if(and__9563__auto__)
...
{var x__10211__auto__ = (((this$ == null))?null:this$);return (function (){var or__9575__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10211__auto__)]);if(or__9575__auto__)
{return or__9575__auto__;
} else
{var or__9575__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9575__auto____$1)
...
return (function (p__13244){var vec__13245 = p__13244;var k = cljs.core.nth.call(null,vec__13245,(0),null);var v = cljs.core.nth.call(null,vec__13245,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
