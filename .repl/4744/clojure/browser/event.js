...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13221 = {};return obj13221;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9577__auto__ = this$;if(and__9577__auto__)
...
{var x__10225__auto__ = (((this$ == null))?null:this$);return (function (){var or__9589__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10225__auto__)]);if(or__9589__auto__)
{return or__9589__auto__;
} else
{var or__9589__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9589__auto____$1)
...
return (function (p__13222){var vec__13223 = p__13222;var k = cljs.core.nth.call(null,vec__13223,(0),null);var v = cljs.core.nth.call(null,vec__13223,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13224){var vec__13225 = p__13224;var k = cljs.core.nth.call(null,vec__13225,(0),null);var v = cljs.core.nth.call(null,vec__13225,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
