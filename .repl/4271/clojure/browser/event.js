...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13217 = {};return obj13217;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9573__auto__ = this$;if(and__9573__auto__)
...
{var x__10221__auto__ = (((this$ == null))?null:this$);return (function (){var or__9585__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10221__auto__)]);if(or__9585__auto__)
{return or__9585__auto__;
} else
{var or__9585__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9585__auto____$1)
...
return (function (p__13218){var vec__13219 = p__13218;var k = cljs.core.nth.call(null,vec__13219,(0),null);var v = cljs.core.nth.call(null,vec__13219,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13220){var vec__13221 = p__13220;var k = cljs.core.nth.call(null,vec__13221,(0),null);var v = cljs.core.nth.call(null,vec__13221,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
