...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13245 = {};return obj13245;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9601__auto__ = this$;if(and__9601__auto__)
...
{var x__10249__auto__ = (((this$ == null))?null:this$);return (function (){var or__9613__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10249__auto__)]);if(or__9613__auto__)
{return or__9613__auto__;
} else
{var or__9613__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9613__auto____$1)
...
return (function (p__13246){var vec__13247 = p__13246;var k = cljs.core.nth.call(null,vec__13247,(0),null);var v = cljs.core.nth.call(null,vec__13247,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13248){var vec__13249 = p__13248;var k = cljs.core.nth.call(null,vec__13249,(0),null);var v = cljs.core.nth.call(null,vec__13249,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
