...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13586 = {};return obj13586;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9541__auto__ = this$;if(and__9541__auto__)
...
{var x__10189__auto__ = (((this$ == null))?null:this$);return (function (){var or__9553__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10189__auto__)]);if(or__9553__auto__)
{return or__9553__auto__;
} else
{var or__9553__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9553__auto____$1)
...
return (function (p__13587){var vec__13588 = p__13587;var k = cljs.core.nth.call(null,vec__13588,(0),null);var v = cljs.core.nth.call(null,vec__13588,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13589){var vec__13590 = p__13589;var k = cljs.core.nth.call(null,vec__13590,(0),null);var v = cljs.core.nth.call(null,vec__13590,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
