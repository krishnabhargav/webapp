...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13203 = {};return obj13203;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9559__auto__ = this$;if(and__9559__auto__)
...
{var x__10207__auto__ = (((this$ == null))?null:this$);return (function (){var or__9571__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10207__auto__)]);if(or__9571__auto__)
{return or__9571__auto__;
} else
{var or__9571__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9571__auto____$1)
...
return (function (p__13204){var vec__13205 = p__13204;var k = cljs.core.nth.call(null,vec__13205,(0),null);var v = cljs.core.nth.call(null,vec__13205,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13206){var vec__13207 = p__13206;var k = cljs.core.nth.call(null,vec__13207,(0),null);var v = cljs.core.nth.call(null,vec__13207,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
